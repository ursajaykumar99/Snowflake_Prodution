...
CREATE DATABASE EDW_TESTING_DB;
USE DATABASE EDW_TESTING_DB;
  CREATE SCHEMA EDW_TEST_LANDING_SC;
  CREATE SCHEMA EDW_TEST_BRONZE_SC;
  CREATE SCHEMA EDW_TEST_SILVER_SC;
  CREATE SCHEMA EDW_TEST_GOLD_SC;
  CREATE SCHEMA EDW_TEST_PROCESS_SC;